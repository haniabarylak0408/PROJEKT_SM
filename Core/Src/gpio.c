...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BMP280_CS2_Pin|BMP280_CS3_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, Heater_Pin|Fan_Pin|LD1EX_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BMP280_CS2_Pin BMP280_CS3_Pin */
  GPIO_InitStruct.Pin = BMP280_CS2_Pin|BMP280_CS3_Pin;
  ...
  /*Configure GPIO pins : LD1_Pin LD2EX_Pin LD3EX_Pin LD3_Pin
                           LD2_Pin */
  ...
  /*Configure GPIO pins : Heater_Pin Fan_Pin LD1EX_Pin */
  GPIO_InitStruct.Pin = Heater_Pin|Fan_Pin|LD1EX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : BMP280_CS1_Pin */
